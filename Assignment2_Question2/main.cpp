...
int main() {
	...
	cout << "Creating a Professional Employee who has a monthly salary of $1156.68/month." << endl;
	Employee* e2 = new ProfessionalEmployee(1156.68);
	cout << "Weekly salary is: $" << e2->calculateWeeklySalary() << " [Should be $289.17]" << endl;
	cout << "The amount from their weekly pay that go towards health care contributions is: $" << e2->calculateHealthCare() << " [Should be $57.834]" << endl;
	cout << "The number of vacation days for a given week is: " << e2->calculateVacationDays() << " [Should be 12]" << endl;
